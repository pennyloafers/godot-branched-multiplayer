...
func _on_network_options_packet_loss_chance(value: float) -> void:
	server.enet.packet_loss_chance = value
	client.enet.packet_loss_chance = value


func _on_network_options_packet_loss_enabled(value: bool) -> void:
	server.enet.packet_loss_enabled = value
	client.enet.packet_loss_enabled = value
